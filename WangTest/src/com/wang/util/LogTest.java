...
public class LogTest {
	...
	public static void main(String[] args) throws Exception {
		...
		fileList.add("/home/wang/文档/虚拟支付/paycore/26-paycore-dal-digest.log");
		fileList.add("/home/wang/文档/虚拟支付/paycore/27-paycore-dal-digest.log");
		fileList.add("/home/wang/文档/虚拟支付/paycore/36-paycore-dal-digest.log");
		fileList.add("/home/wang/文档/虚拟支付/paycore/37-paycore-dal-digest.log");
		getLogMs(fileList);
	...
	private static void getLogMs(List<String> fileList) throws Exception {
		...
		Pattern pattern = Pattern.compile(".*,[2-9]\\dms.*|.*,\\d{3,}?ms.*");
	 ...
	 private static void openFileForWrite() {
		   try {
	           ...
	           File file2 = new File("resultStat.csv");
    ...
    private static class LogEntry{
    	...
    	public static LogEntry splitLog(String str) {
    		...
    		if (array.length>=4) {
    		    logEntry.setName(array[2]);
    		    logEntry.setTime(array[0]);
    		    
    		    int msPos = array[4].indexOf("ms)");
    		    String timeStr = array[4].substring(0, msPos);
    		    logEntry.setConsumeTime( Integer.valueOf(timeStr) ) ;
    		    
    		    int sqlStartPos = str.indexOf("ms)(");
    		    String sql = str.substring(sqlStartPos+3);
//    		    if (array.length>=6) {
//    		    	sql = array[4].substring(sqlStartPos+3) + array[5];
//    		    }
